...
template <typename T=int, int init=3> //template can use default type and value
class MyArray{
	private:
		vector<T> list;
	public:
...
template <typename T, int init> //do not repeat default type and value
