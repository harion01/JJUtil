...
int main(){
	...
	person.introduce(); //in this case, Person::introduce will be called. not Chulsoo::introduce.
	cout << "=== After Chulsoo -> Person upcasting ===" << endl;

	
	cout << "=== Before Chulsoo -> Person upcasting by reference  ===" << endl;
	Person& personUpRef = chulsoo;
	personUpRef.introduce(); //in this case, personUpRef can use Chulsoo::introduce and upcased values
	cout << "=== After Chulsoo -> Person upcasting by reference ===" << endl;

	cout << "=== Before Chulsoo -> Person upcasting by pointer  ===" << endl;
	Person* personUpPtr = &chulsoo;
	personUpPtr->introduce(); //in this case, personUpPtr can use Chulsoo::introduce and upcased values
	cout << "=== After Chulsoo -> Person upcasting by pointer ===" << endl;
